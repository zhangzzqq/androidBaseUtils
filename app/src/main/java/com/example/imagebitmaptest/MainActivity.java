...
//        imageView3.setImageBitmap(bitmap);
    ...
    private Bitmap readBitMap() {
         ...
         * 获取资源图片
         */
        @SuppressLint("ResourceType") InputStream is = this.getResources().openRawResource(R.drawable.mei5);
